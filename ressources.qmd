...
* [En format Quarto](https://rstudio.github.io/r-manuals)
* [htsur le CRAN](https://cran.r-project.org/manuals.html)
...
## Sites
* [CRAN Views](http://cran.r-project.org/web/views/) : pour bien commencer avec les packages. Organisé par tâches (par exemple les Omics, l'inférence bayésienne, etc.) et "curationné" avec amour.
